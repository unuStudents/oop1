...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- OOP1 -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/oop1'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>OOP1</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- OOP2 -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/oop2'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>OOP2</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- OOP3 -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/oop3'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>OOP3</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- OOP3.2 -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/oop32'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>OOP3.2</span></a>
            </li>
            <!-- Divider -->
            ...
            <!-- OOP4 -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('/oop4'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>OOP4</span></a>
            </li>
            <!-- Divider -->
